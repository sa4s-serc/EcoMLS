...
class Planner():
    ...
    def generate_adaptation_plan(self, count, energy_of_component):
        ...
        # decide whether to switch to a model with lower energy
        if self.energy_consumption > (1+0.25)*model_avg_energy: #High energy
            ...
            for model, data in self.knowledge.items():
                ...
                # if the energy is less than the current energy and the confidence is greater than equal to the current confidence
        ...
        # decide to switch to a model with higher confidence 
        else: #medium energy
            ...
            for model, data in self.knowledge.items():
                ...
                # if the confidence is greater than the current confidence
