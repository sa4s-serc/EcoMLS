...
class ImageProcessor:
    ...
    def load_models(self):
        ...
        for m in {'yolov5n', 'yolov5s', 'yolov5m', 'yolov5l', 'yolov5x'}:
            ...
            #     'ultralytics/yolov5', m, force_reload=False, skip_validation=True)
            z = m + 'u.pt'
            models[m] = YOLO(z)        
        return models
...
# 0,0.58142,5.400071,0.535623
# 1,1.532711,11.277009,0.610662
# 2,2.510857,18.160476,0.651521
# 3,4.492237,34.170445,0.675032

# 0,0.58142,5.400071,0.535623,50.0
...
# 2,2.510857,18.160476,0.6327082267461154,9.786718
# 3,4.492237,34.170445,0.686500865969553,22.896304
